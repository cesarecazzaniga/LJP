...
class svjHelper(object):
    ...
    def getOutName(self):
        _outname = "SVJ"
        _outname += "_mZprime_{:g}".format(self.mZprime)
        _outname += "_mDark_{:g}".format(self.mDark)
        _outname += "_rinv_{:g}".format(self.rinv)
        if len(self.alphaName)>0: _outname += "_alpha_"+(self.alphaName)
        else: _outname += "_alpha_{:g}".format(self.alpha)
        return _outname
    ...
    def getPythiaSettings(self):
        lines = [
            ...
            '4900113:m0 = {:g}'.format(2.7*self.mDark),
            '4900213:m0 = {:g}'.format(2.7*self.mDark),
            '53:m0 = 0.0',
            ...
            'SpaceShower:QCDshower = off         ! No ISR SM Showering',
            'TimeShower:QCDshower = off           ! No FSR SM Showering',
            'ParticleDecays:FSRinDecays = off    ! No SM Showering of Decays',
            'HadronLevel:Hadronize = off             ! No SM Hadronization',

            # possible decays
            '4900111:mayDecay = off       ! Dark Diagonal Pion Stability',
            '4900113:mayDecay = off        ! Dark Diagonal Rho Stability',
            '4900211:mayDecay = off        ! Dark Off-Diagonal Pion Stability',
            '4900213:mayDecay = off        ! Dark Off-Diagonal Rho Stability',
            # decouple
            '4900001:m0 = 5000',
            '4900002:m0 = 5000',
            '4900003:m0 = 5000',
...
if __name__=="__main__":
    ...
    group_alpha.add_argument("--alpha", dest="alpha", type=str, default=None, help="dark coupling strength (str or float)")
    ...
    fname = '#Here you have to write your own Pythia_card directory' + helper.getOutName() + ".cmnd"  
